...
./esptool.py --chip esp32 --port ${device} --baud 115200 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0xe000 boot_app0.bin 0x1000 bootloader_qio_80m.bin 0x10000 iot-temp-ble-esp32.ino.bin 0x8000 iot-temp-ble-esp32.ino.partitions.bin
echo "Done"
